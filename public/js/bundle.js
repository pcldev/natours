    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); //location reload make the website reload
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29uZ2xvbmdnIiwiYSI6ImNrcnEzbzZteTA5MDUydGxlbHhsaG9kd24ifQ.HeCiGU-ZHWFL4TLhFNKxWg';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/conglongg/ckrq4x780era917o5l0qlrjes',
    // style URL
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_51JMUVrBaOSK7KIeB6O7XGJf5iIIF9noWdJFPsXyUH7FUApw8Ks7vnbZL0DrWowRN8N7hQU9O6kT9gjIQlO5tjebo00lqw6Vw2V');

var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, quantity) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            tourId = window.location.pathname.split('/')[3];
            _context.next = 4;
            return (0, _axios.default)({
              method: 'POST',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Thanks for your review!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/likings/post-like/".concat(tourId)
            });
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Thanks for your loving ❤️');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/likings/updateLiking/".concat(tourId)
            });
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Hic 😒');
            }
...
var updateReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, rating, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"crudTour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createTour = exports.deleteTour = exports.updateTour = void 0;
...
var updateTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, data) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var _crudTour = require("./crudTour");
...
var queryForm = function queryForm(thisQuery, func) {
  var forms = thisQuery.querySelectorAll('input');
  var values = Array.from(forms).map(function (val) {
    return val.value;
  });
...
var updateReviewBtns = document.querySelectorAll('#update__review');
var updateTourBtn = document.getElementById('save-update-tour-btn');
var deleteTourBtn = document.getElementById('btn--delete-tour');
var createTourBtn = document.getElementById('btn--create-tour');
var logOutBtn = document.querySelector('.nav__el--logout');

if (postBtn) {
  // const post = document.querySelector('.post');
  var stars = document.querySelectorAll('.fas.fa-star');
  var textarea = document.querySelector('body > section.section-reviews > div.review__block > div > div.star-widget > form > div.textarea > textarea');
  var starRating = 1;
  ...
  postBtn.onclick = function (e) {
    e.preventDefault();
    (0, _review.postReview)(textarea.value, starRating); // widget.style.display = 'none';
...
if (likeBtn) {
  likeBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var heartIcon;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            heartIcon = document.querySelector('.heart__icon');
...
if (updateReviewBtns) {
  updateReviewBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var id = e.target.closest('#update__review').dataset.reviewid;
      var rating = e.target.closest('.card__footer').parentElement.querySelector('select').value;
      var reviewing = e.target.closest('.card__footer').parentElement.querySelector('textarea').value;
      (0, _updateReview.updateReview)(id, rating, reviewing);
    });
  });
}
...
if (updateTourBtn) {
  updateTourBtn.addEventListener('click', function (e) {
    ...
    var titleNum = ['duration', 'price'];
    var titleText = ['name', 'summary', 'description'];
    var startDates = [];
    var data = {};
    dates.forEach(function (date) {
      return startDates.push( // new Date(`${date.value}T09:00:00.000+00:00`).toJSON().valueOf()
      new Date(date.value));
    });
    data['startDates'] = startDates;
    data['difficulty'] = difficulty; //obj["key3"] = "value3"; *

    inputNum.forEach(function (num, idx) {
      data[titleNum[idx]] = num.value;
    });
    inputText.forEach(function (text, idx) {
      data[titleText[idx]] = text.value;
    });
    (0, _crudTour.updateTour)(tourId, data);
  });
}
...
if (createTourBtn) {
  ...
  createTourBtn.addEventListener('click', function (e) {
    ...
    var data = {};
    var formStartLocation = document.querySelectorAll('#startLocation > input');
    var formimages = document.querySelectorAll('#images > input');
    var formStartDates = document.querySelectorAll('#startDates > input ');
    var formLocations = document.querySelectorAll('#locations > input');
    var anotherForm = document.querySelectorAll('#another > input');
    var anotherTextArea = document.querySelectorAll('#another > textarea');
    var coordinates_startLocation = document.querySelectorAll('#coordinates--startLocation > input');
    var coordinates_locations = document.querySelectorAll('#coordinates--locations > input');
    var coordinatesStartlocation = [];
    var coordinatesLocations = [];
    var startLocationArr = ['description', 'type', 'address'];
    var startLocation = {};
    var images = [];
    var startDates = [];
    var locations = [];
    var location = {};
    var locationtitleArr = ['description', 'type', 'day'];
    submitBtn.addEventListener('click', function (e) {
      e.preventDefault();
      formStartLocation.forEach(function (val, index) {
        // if(startLocationArr[index]==='coordinates') startLocation[`${startLocationArr[index]}`]=
        startLocation["".concat(startLocationArr[index])] = val.value;
      });
      data['startLocation'] = startLocation;
      coordinates_startLocation.forEach(function (val) {
        coordinatesStartlocation.push(parseInt(val.value));
      });
      data.startLocation.coordinates = coordinatesStartlocation;
      formimages.forEach(function (val, index) {
        images.push(val.value);
      });
      data['images'] = images;
      formStartDates.forEach(function (val, index) {
        startDates.push(val.value);
      });
      data['startDates'] = startDates;
      formLocations.forEach(function (val, index) {
        location["".concat(locationtitleArr[index])] = val.value;
      });
      locations.push(location);
      data['locations'] = locations;
      anotherForm.forEach(function (val, index) {
        data["".concat(val.attributes['name'].value)] = val.value;
      });
      anotherTextArea.forEach(function (val, index) {
        data["".concat(val.attributes['name'].value)] = val.value;
      });
      coordinates_locations.forEach(function (val) {
        coordinatesLocations.push(parseInt(val.value));
      });
      data.locations[0].coordinates = coordinatesLocations;
      console.log(data); // createTour(data);
    });
  });
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var passwordCurrent, password, passwordConfirm, check;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 7:
              ...
              document.querySelector('.btn--password').textContent = check ? 'Update successfully!' : 'Update failed';
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13280" + '/');
