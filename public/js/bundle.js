...
var cmtBtn = document.querySelector('.postReview');
...
if (cmtBtn) {
  (function () {
    var starRate = function starRate(e) {
      var type = e.type;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10124" + '/');
